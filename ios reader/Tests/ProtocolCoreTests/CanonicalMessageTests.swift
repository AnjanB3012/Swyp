...
final class CanonicalMessageTests: XCTestCase {
    ...
    func testDERKeyAndSignatureRoundTrip() throws {
        ...
        let challenge = TransactionChallenge(
            amountCents: 100, currency: "USD", merchant: "Kroger", terminalId: "swyp-terminal-01",
        ...
        let credential = SwypCredential(
            credentialId: "cred_amex_01", displayName: "Everyday", last4: "5678", network: "Swyp",
